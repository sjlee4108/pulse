...
class Party {
  ...
  String password;
  bool needPassword;
  Party(String N, String L, List<String> pl, String p, bool NP) {
    this.name =  N;
    this.location = L;
    this.playlist = pl;
    this.password = p;
...
void main(){
  Party p1 =  new Party("Jason's Party", "Foss",["Hangang","Break Bread"], "a", false);
  Party p2 =  new Party("Arthur's Party", "Mary Low",["Sleep","until 4"], "b", true);
